...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/clock-en/connect-sample-backend/pbgen/submodules/protobuf/greet/v1"
	http "net/http"
	strings "strings"
)
...
func NewGreetServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) GreetServiceClient {
	...
	greetServiceMethods := v1.File_submodules_protobuf_greet_v1_greet_proto.Services().ByName("GreetService").Methods()
