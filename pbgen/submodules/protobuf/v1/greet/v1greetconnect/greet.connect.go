...
package v1greetconnect

import (
	connect "connectrpc.com/connect"
	context "context"
	errors "errors"
	greet "github.com/clock-en/connect-sample-backend/pbgen/submodules/protobuf/v1/greet"
	http "net/http"
	strings "strings"
)
...
func NewGreetServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) GreetServiceClient {
	...
	greetServiceMethods := greet.File_submodules_protobuf_v1_greet_greet_proto.Services().ByName("GreetService").Methods()
